...
# Table of contents
 ...
 - [Part 3 (this post)]({% post_url 2021-07-04-pulprog3 %}): Running the experiment
...
**Exercise.** Add a few comments to the main part of the pulse programme to remind yourself of what each line represents.
...
<img src="/assets/images/pulprog/edc_700.png" alt="edc window on AV700" width="400" />
<br />
</div>
...
<div style="text-align: center">
<img src="/assets/images/pulprog/eda_pulprog.png" alt="eda window on AV700" width="500" />
<br /><br />
</div>

 - After that, click on the NMR-tube-like button on the top bar (see arrow above), or equivalently, type `ased` in the TopSpin command line.
...
<div style="text-align: center">
<img src="/assets/images/pulprog/ased_700.png" alt="ased window on AV700" width="500" />
<br />
</div>
