...
{% include imgc.html 
src="/assets/images/pulprog/pulacq.png"
alt="Standard zg sequence"
width="150"
%}
...
{% include imgc.html 
src="/assets/images/pulprog/new_mypulacq.png"
...
{% include imgc.html 
src="/assets/images/pulprog/zg_graphical1.png"
alt="TopSpin's graphical edit view of our (incomplete) zg pulse programme"
width="500"
%}
...
In [the next post]({% post_url 2021-07-04-pulprog3 %}), we'll see how to run this experiment; we'll also make some small but useful improvements to the pulse programme.
